...
Those wishing to _use_ the shiny interface with their own data will want to read about the data structures, or contact me.
Those wishing to _extend_ capabilities of the package, or understand its inner working, will be interested in the package organization.
This developer guide was generated with the help of Antigravity, with significant editing and rewriting;
see
[Create Developer’s Guide to `qtl2shiny`](https://byandell.github.io/Documentation/prompts/devel_guide.html).

## Table of Contents

- [Data Structures and Folder Organization](#data-structures-and-folder-organization)
...
- [Package Workflow and Shiny Tool Components](#package-workflow-and-shiny-tool-components)
- Detailed Module Guides
  - [Module Architecture](./module.html)
...
```{r echo=FALSE, child=system.file("scripts", "qtl2dag.Rmd", package = "qtl2shiny")}
