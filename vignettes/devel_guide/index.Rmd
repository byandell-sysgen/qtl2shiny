...
- [Hotspots & Phenotypes Panel (`hotspotApp`)](./hotspotApp.html)
- [Allele & SNP Scans Panel (`scanApp`)](./scanApp.html)
- [Patterns Panel (`patternApp`)](./patternApp.html)
- [Genotypes Panel (`genoApp`)](./genoApp.html)
- [Mediation Panel (`mediateApp`)](./mediateApp.html)
- [Scatter Plot Module (`scatterPlotApp`)](./scatter_plot.html)
...
- **Constituent Modules**:
  - [R/genoDataApp.R](../../../R/genoDataApp.R): Renders genotype probabilities and SDP pairings at a chosen physical marker. For a deep-dive, see the [Genotypes Panel Guide](genoApp.html).
