...
[Create Developer Guide to `qtl2shiny`](https://byandell.github.io/Documentation/prompts/devel_guide.html)
...
- [Hotspots & Phenotypes Panel (`hotspotApp`)](./hotspot.html)
- [Allele & SNP Scans Panel (`scanApp`)](./scan.html)
- [Patterns Panel (`patternApp`)](./pattern.html)
- [Genotypes Panel (`genoApp`)](./geno.html)
- [Scatter Plot Modules (`scatterPlotApp` / `scatterApp`)](./scatter.html)
- [Mediation Panel (`mediateApp`)](./mediate.html)
...
- **Main Body**: Organizes the app into six major navigation tabs (`bslib::nav_panel`):
...
- **Constituent Modules**:
  - [R/genoDataApp.R](../../../R/genoDataApp.R): Renders genotype probabilities and SDP pairings at a chosen physical marker. For a deep-dive, see the [Genotypes Panel Guide](geno.html).
...
- **Entrypoint**: [R/scatterApp.R](../../../R/scatterApp.R)
- **Constituent Modules**:
  - [R/scatterPlotApp.R](../../../R/scatterPlotApp.R): Reusable generic plotting module managing aesthetic mappings, open symbol selections, and linetypes.
...
| **Scatter Plot** | | | |
| [R/scatterApp.R](../../../R/scatterApp.R) | Scatter Plot | Entrypoint Panel | `scatterServer` |
| [R/scatterPlotApp.R](../../../R/scatterPlotApp.R) | Scatter Plot | Integral Submodule | `scatterPlotServer` |
| **Mediation** | | | |
