...
hotspotServer <- function(id, project_df,
  ...
  shiny::moduleServer(id, function(input, output, session) {
    ...
    hotspot_obj <- hotspotDataServer(
      "hotspot_obj", set_par, peak_read_df,
      pmap_obj, project_df
    )
    ...
    pheno_list <-
      phenoServer("pheno_panel", set_par, win_par, peak_df, pmap_obj, hotspot_df, project_df)
...
hotspotUI <- function(id) {
  ...
  shiny::tagList(
    ...
    bslib::layout_columns(
      ...
      hotspotDataInput(ns("hotspot_obj"))
    )
  ) # chr_ct, minLOD
  ...
  bslib::navset_tab(
    ...
    bslib::nav_panel(
      ...
      shiny::tagList(
        ...
        hotspotTableOutput(ns("hotspot_df"))
      )
    ), # hotspot_table
    bslib::nav_panel(
      "Phenotypes",
